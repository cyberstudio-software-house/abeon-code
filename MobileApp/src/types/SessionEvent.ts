 ...
 */
export type SessionEvent = { "type": "sessionAppend", sessionId: string, blocks: Array<HistoryBlock>, } | { "type": "sessionActivity", sessionId: string, activity: SessionActivity, } | { "type": "sessionTitle", sessionId: string, title: string, } | { "type": "sessionUsage", sessionId: string, summary: UsageSummary, } | { "type": "sessionRoster", entries: Array<RosterEntry>, };
