...
function sessionMeta(id: string, projectId: number, activity: SessionMeta['activity']): SessionMeta {
  return { id, projectId, title: `S-${id}`, messageCount: 1, lastModified: 9, createdAt: null, gitBranch: null, cwd: null, activity, provider: 'codex', runningAgents: 0, totalAgents: 0 };
}
